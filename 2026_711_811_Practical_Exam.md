...
1. Use an absolute path to change your current working directory to the 'prac_exam' directory that you just cloned (2 points). 
 cd /home/users/msm1094/prac_exam_2026
...
mkdir data | cd data | mkdir untrimmedfastq
...
cp /tmp/Gen711-811_data/*.fastq* /home/users/msm1094/prac_exam_2026/data/untrimmed_fastq/
...
grep -c '^@' SRR2584863_2.fastq 
2145318

grep -c '^@' SRR2584866_2.fastq 
3431525
...
[msm1094@ron untrimmed_fastq]$ grep -c 'NNNNNNNNNNNNNNN' SRR2584863_2.fastq
3015
...
grep -B1 -A2 'NNNNNNNNNNNNNNN' SRR2584863_2.fastq > bad-reads.fastq
grep -B1 -A2 'NNNNNNNNNNNNNNN' SRR2584866_2.fastq >> bad-reads.fastq
